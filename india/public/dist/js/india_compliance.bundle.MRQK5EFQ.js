(() => {
  ...
  // ../india/india/public/js/regex_constants.js
  ...
  // ../india/india/public/js/utils.js
  ...
  Object.assign(india_compliance, {
    ...
    async set_gstin_status(field, transaction_date, force_update = 0) {
      ...
      if (!message)
        return field.set_description("");
      field.set_description(india_compliance.get_gstin_status_desc(message == null ? void 0 : message.status, message == null ? void 0 : message.last_updated_on));
    ...
    set_reconciliation_status(frm, field) {
      ...
      frm.get_field(field).set_description(`<div class="d-flex indicator ${color}">
  ...
  // ../india/india/public/js/quick_entry.js
      ...
      return [
        __spreadProps(__spreadValues({}, frappe.meta.get_docfield(this.doctype, "gstin")), {
          ...
          onchange: () => {
            ...
            d.set_value("gst_category", india_compliance.guess_gst_category(d.doc._gstin, d.doc.country));
          }
        })
      ];
    }
        ...
        },
        {
          ...
          onchange: async () => {
            ...
            if (!link_name || !in_list(frappe.boot.gst_party_types, link_doctype))
              return;
            const { message: gstin_list } = await frappe.call("india_compliance.gst_india.utils.get_gstin_list", { party_type: link_doctype, party: link_name });
  ...
  // ../india/india/public/js/transaction.js
  frappe.provide("india_compliance");
  ...
  function fetch_gst_details(doctype) {
    ...
    const events = Object.fromEntries(event_fields.map((field) => [field, (frm) => update_gst_details(frm, field)]));
  ...
  async function update_gst_details(frm, event) {
    ...
    if (in_list(frappe.boot.sales_doctypes, frm.doc.doctype)) {
      fieldnames_to_set.push("customer_address", "billing_address_gstin", "is_export_with_gst");
    } else {
  ...
  async function _set_gstin_status(frm, gstin_field_name) {
    ...
    if (!gstin_doc) {
      ...
      gstin_field.set_description(india_compliance.get_gstin_status_desc(gstin_doc == null ? void 0 : gstin_doc.status, gstin_doc == null ? void 0 : gstin_doc.last_updated_on));
    }
    return gstin_doc;
  }
  ...
  // ../india/india/public/js/audit_trail_notification.js
  $(document).on("app_ready", async function() {
    ...
    const d = frappe.msgprint({
      ...
      indicator: "orange",
      message: __(`Dear India Compliance User,
            <br><br>
  ...
  // ../india/india/public/js/quick_info_popover.js
  frappe.provide("india_compliance");
...
//# sourceMappingURL=india_compliance.bundle.MRQK5EFQ.js.map
