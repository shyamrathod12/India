(() => {
  ...
  // ../india/india/public/js/purchase_reconciliation_tool/data_table_manager.js
  ...
  india_compliance.DataTableManager = class DataTableManager {
    ...
    make() {
      ...
      for (const column of this.datatable.getColumns()) {
        ...
        this.columns_dict[fieldname].$filter_input = $(`.dt-row-filter .dt-cell--col-${column.colIndex} .dt-filter`, this.$datatable)[0];
      }
    }
    ...
    get_dt_column(column) {
      ...
      let format = function(value, row, column2, data) {
        ...
        return frappe.form.get_formatter(column2.docfield.fieldtype)(value, column2.docfield, { always_show_decimals: true }, data);
      };
  ...
  // ../india/india/public/js/purchase_reconciliation_tool/filter_group.js
  frappe.provide("india_compliance");
  ...
  var _Filter = class extends frappe.ui.Filter {
    set_conditions_from_config() {
      ...
      this.conditions = this.conditions.filter((condition) => india_compliance.FILTER_OPERATORS[condition && condition[0]]);
    }
  };
  ...
  // ../india/india/public/js/purchase_reconciliation_tool/number_card.js
  frappe.provide("india_compliance");
...
//# sourceMappingURL=purchase_reconciliation_tool.bundle.WDWX55GS.js.map
