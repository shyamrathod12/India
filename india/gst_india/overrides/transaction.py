...
from india.gst_india.constants import SALES_DOCTYPES, STATE_NUMBERS
from india.gst_india.doctype.gstin.gstin import (
...
from india.income_tax_india.overrides.tax_withholding_category import (
